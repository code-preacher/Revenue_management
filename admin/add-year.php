            ...
            <div class="container-fluid">
                ...
                <div class="row">
                   ...
                   <form action="#" method="post">
                          ...
                          <textarea class="form-control" placeholder="Enter Year i.e 1987 etc..." name="year" required="required" rows="1"></textarea>
                          </div>
                                  </div>
                                   ...
                                   <div class="col-md-4">
                           <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-plus"></i>&nbsp;Add Year</button>
                           </div>
